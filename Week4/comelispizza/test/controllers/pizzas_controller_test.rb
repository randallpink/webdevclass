...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { description: @pizza.description, name: @pizza.name, photo: @pizza.photo, price: @pizza.price }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { description: @pizza.description, name: @pizza.name, photo: @pizza.photo, price: @pizza.price }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
